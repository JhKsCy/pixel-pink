function addHTMLNavbar() {
    ...
    var contentHTML = `
        <div class="navbar__icon">
            <a href="#"><img src="./assets/img/icon-wb.png" alt="pixel-pink"></a>
        </div>
        ...
        <div class="navbar__buttons">
            <ul>
                ...
                <li>
                    <a href="./assets/pages/sing-up.html" target="_blank"><i class="fa-solid fa-user"></i></a>
                </li>
                <li>
...
function addHTML() {
    ...
    var contentHTML = `
        <div class="footer__icon">
            <img src="./assets//img/icon-wb.png" alt="Pixel-pink-icon">
        </div>
        <div>
            <h4>
                Explora
        ...
        <div>
            ...
            <ul>
                ...
                <li><a href="./assets/pages/about-us.html" target="_blank">
                    Deskarito
                </a></li>
                <li><a href="">
                    MrsParkDo
